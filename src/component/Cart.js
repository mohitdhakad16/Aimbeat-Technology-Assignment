...
export default function Cart({ toggleSideMenu }) {
    return (
        <div>
            <div className="container">
                <div className="sortButtons flex items-center justify-between">
                    <div className="btns flex items-center">
                        <button
                            type="button"
                            className="gridBtn relative inline-flex items-center p-2 text-sm font-medium text-center border border-gray-200 text-white bg-gray-100 hover:bg-gray-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            onClick={toggleSideMenu} // This is where the slide menu toggles
                        >
                            <svg
                        ...
                        <button
                            type="button"
                            className="relative inline-flex items-center mx-4 p-2 text-sm font-medium text-center border border-gray-200 text-white bg-gray-100 hover:bg-gray-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        >
                            <svg
                                className="w-6 h-6 text-gray-800 dark:text-white"
                                aria-hidden="true"
                        ...
                        <div className="products-Data font-normal text-md mx-4 text-gray-600">Showing 1-14 of 26 results</div>
                    </div>

                    <div className="filterBtn">
                        <div className="filterButtons flex justify-start">
                            <button
                                type="button"
                ...
                <section class="py-8 antialiased dark:bg-gray-900 md:py-12">
                    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                        ...
                        <div class="mb-4 grid gap-4 grid-cols-1 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
